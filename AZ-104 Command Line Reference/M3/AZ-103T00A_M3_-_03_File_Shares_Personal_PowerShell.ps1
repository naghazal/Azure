...
New-AzStorageAccount -ResourceGroupName $resourceGroup -AccountName saaz103t00m3fileshare -Location $location -SkuName "Standard_LRS" -Kind StorageV2

#Retrieve Storage Account Key
Get-AzStorageAccountKey -ResourceGroupName "RG-AZ103T00M3-Fileshare" -AccountName "saaz103t00m3fileshare"

#Create a File Share using PowerShell
#Create Storage Context and Key (Key must be retrieved)
$storageContext = New-AzStorageContext saaz103t00m3fileshare fOvSf2ZaQusfCGasllbTxq1nTvBiIobUyw+D4KXsZvO5ZQusinUqzS89gqqWvgu6fEEIO8ot6IeN+0zqgtuQiA==
...
$storageAccountName = "saaz103t00m3fileshare"
$fileShareName = "logs"
...
New-PSDrive -Name Z -PSProvider FileSystem -Root "\\saaz103t00m3fileshare.file.core.windows.net\logs" -Credential $credential -Persist
